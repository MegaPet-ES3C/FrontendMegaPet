<template>
  ...
  <div class="card">
    ...
    <pv-dialog header="Help Form" v-model:visible="displayHelpForm" :style="{ width: '450px' }" :modal="true" class="p-fluid" >
      ...
      <div class="field mt-4">
        <span class="p-float-label">
          <pv-input-text  type="text" id="name" v-model.trim="pet.description" required="true" :class="{ 'p-invalid': submitted && !pet.description }" disabled/>
          <label for="description"> Description </label>
        </span>
      </div>
      <div class="field mt-4">
        <span class="p-float-label">
          <pv-input-text  type="text" id="name" v-model.trim="pet.image" required="true" :class="{ 'p-invalid': submitted && !pet.image }" disabled/>
          <label for="image"> Image </label>
        </span>
      </div>
      <div class="field mt-4">
        <span class="p-float-label">
          <pv-input-text  type="text" id="name" v-model.trim="pet.rescuedTime" required="true" :class="{ 'p-invalid': submitted && !pet.rescuedTime }" disabled/>
          <label for="rescuedTime"> Rescued Time </label>
        </span>
      </div>
      <div class="field mt-4">
        <span class="p-float-label">
          <pv-input-text  type="text" id="name" v-model.trim="pet.category" required="true" :class="{ 'p-invalid': submitted && !pet.category }" disabled/>
          <label for="category"> Category </label>
        </span>
      </div>
      <div class="field mt-4">
        <span class="p-float-label">
          <pv-input-text  type="text" id="name" v-model.trim="pet.inventoryStatus" required="true" :class="{ 'p-invalid': submitted && !pet.inventoryStatus }" disabled/>
          <label for="status"> Status  </label>
        </span>
      </div>
      <div class="field mt-4">
        <span class="p-float-label">
          <pv-input-text  type="text" id="name" v-model.trim="pet.rating" required="true" :class="{ 'p-invalid': submitted && !pet.rating }" disabled/>
    ...
    openSubscriptionDialog(adopter) {
      ...
      if (
        ...
        if (this.adopter.id) {
          ...
          this.adopter.id = this.increase;
          console.log(this.adopter);
          this.adopter = this.getStorableAdopter(this.adopter);
          this.adoptersService.create(this.adopter)
